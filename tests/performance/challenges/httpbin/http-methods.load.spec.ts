...
test.describe('HTTPBin HTTP Methods Load Test', () => {
  test('should handle HTTP methods load', async () => {
    const configPath = 'tests/performance/challenges/httpbin/config/http-methods-load.yml';
