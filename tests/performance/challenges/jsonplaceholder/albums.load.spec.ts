...
test.describe('JSONPlaceholder Albums Load Test', () => {
  test('should handle normal load', async () => {
    const configPath = 'tests/performance/challenges/jsonplaceholder/config/albums-load.yml';
    ...
    if (result.results) {
      ...
      const thresholds = getJSONPlaceholderThresholds('albums');
