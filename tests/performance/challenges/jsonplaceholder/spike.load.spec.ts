...
test.describe('JSONPlaceholder Spike Test', () => {
  test('should handle spike load', async () => {
    const configPath = 'tests/performance/challenges/jsonplaceholder/config/spike-test.yml';
